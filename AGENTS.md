...
1. 要件ドキュメントを作成・改訂する前に、必ず `requirements-template.md` のテンプレートを参照してください。
2. 要求分析は `analysis-template.md`、設計は `design-template.md`、実装計画は `plan-template.md`、意思決定は `adr-template.md` に沿って作成し、それぞれを `analysis.md`、`design.md`、`plan.md`、`ADR` 系のファイルとしてプロジェクトに取り込んでください。
